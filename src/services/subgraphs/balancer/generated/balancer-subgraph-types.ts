...
export function getSdk(
  ...
  return {
    BalancerProtocolData(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerProtocolDataQuery>(
    ...
    BalancerPoolShares(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerPoolSharesQuery>(
            BalancerPoolSharesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerPoolShares',
    ...
    BalancerTokenPrices(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerTokenPricesQuery>(
    ...
    BalancerTokens(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerTokensQuery>(
            BalancerTokensDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerTokens',
    ...
    BalancerPoolSnapshots(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerPoolSnapshotsQuery>(
    ...
    BalancerLatestPrices(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerLatestPricesQuery>(
    ...
    BalancerLatestPrice(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerLatestPriceQuery>(
            BalancerLatestPriceDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerLatestPrice',
    ...
    BalancerJoinExits(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerJoinExitsQuery>(
    ...
    BalancerPortfolioData(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerPortfolioDataQuery>(
            BalancerPortfolioDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerPortfolioData',
    ...
    BalancerPortfolioPoolsData(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerPortfolioPoolsDataQuery>(
            BalancerPortfolioPoolsDataDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerPortfolioPoolsData',
    ...
    BalancerTradePairSnapshots(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerTradePairSnapshotsQuery>(
            BalancerTradePairSnapshotsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerTradePairSnapshots',
    ...
    BalancerAmpUpdates(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerAmpUpdatesQuery>(
            BalancerAmpUpdatesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerAmpUpdates',
    ...
    BalancerGradualWeightUpdates(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerGradualWeightUpdatesQuery>(
            BalancerGradualWeightUpdatesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerGradualWeightUpdates',
    ...
    BalancerGetMeta(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BalancerGetMetaQuery>(
            BalancerGetMetaDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'BalancerGetMeta',
