...
export type GaugeLiquidityGaugeAddressesQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export function getSdk(
  ...
  return {
    GaugeLiquidityGauges(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GaugeLiquidityGaugesQuery>(
            GaugeLiquidityGaugesDocument,
            variables,
    ...
    GaugeLiquidityGaugeAddresses(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GaugeLiquidityGaugeAddressesQuery>(
            GaugeLiquidityGaugeAddressesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'GaugeLiquidityGaugeAddresses',
    ...
    GaugeUserGauges(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GaugeUserGaugesQuery>(
            GaugeUserGaugesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'GaugeUserGauges',
